...
class SeaIceSTUNet(nn.Module):
    def __init__(self, input_channels=11, tcn_channels=64, tcn_layers=3, unet_features=[64, 128, 256, 512], pred_L=3):
        super().__init__()
        self.pred_L = pred_L
...
num_epochs = 30
model = SeaIceSTUNet(input_channels=11, tcn_channels=64, tcn_layers=3, unet_features=[64,128,256,512], pred_L=3).to(device)
...
def plot_sic_error_map(pred, true, mask, x_coords, y_coords, dates, start_idx, save_dir='./results/STUNet_3_Climate_SIC'):
