...
num_epochs = 30
model = SeaIceGRU(input_channels=11, hidden_size=64, pred_L=1).to(device)
...
def plot_sic_error_map(pred, true, mask, x_coords, y_coords, dates, start_idx, save_dir='./results/GRU_1_Climate_SIC'):
