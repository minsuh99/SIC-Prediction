...
num_epochs = 30
model = SeaIceTransformer(input_channels=10, hidden_size=64, pred_L=3).to(device)
...
# Visualization
def plot_sic_error_map(pred, true, mask, x_coords, y_coords, dates, start_idx, save_dir='./results/Transformer_3'):
